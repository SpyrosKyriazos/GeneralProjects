...
public class EntitiesGenerator {
    ...
    public GameCharacter generateCharacter(String charName, String raceName, String className) {
        ...
        GameCharacter character = new GameCharacter(charName, null);
        //attributes
...
//        String name2 = raceName.toString();
        GameCharacter character = new GameCharacter("mplarg", null);
        //class
...
//    }
    ...
    private Weapon generateFirstWeapon() {
        Weapon weapon = new Weapon("dagger", 1, null, null);
        return weapon;
    }
...
//        String name = names[randomGenerator.nextInt(names.length)].toString();
        Weapon weapon = new Weapon("weapon1", playerLevel, null, null);
        return weapon;
    }
...
//            effects.add(effect1);
//            CharacterClass characterClass = new CharacterClass(className.toString(), effects);
